            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 bg-[var(--bg-card)] rounded-t-[24px] z-[1001] flex flex-col px-6 pt-2 pb-10 max-h-[70vh]"
                    >
                        {/* Handle */}
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-[20px] font-semibold text-[var(--text-primary)]">Favorites</h2>
                            <MdEditNote size={24} className="text-[var(--text-primary)] cursor-pointer" onClick={() => {
                        ...
                        <div className="space-y-6 overflow-y-auto no-scrollbar">
                            {options.map(opt => (
                                ...
                                >
                                    <span className={`text-[17px] text-[var(--text-primary)] ${selected === opt ? 'font-medium' : 'font-normal'}`}>{opt}</span>
                                    {selected === opt && (
