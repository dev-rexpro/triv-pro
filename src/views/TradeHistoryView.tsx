                ...
                <div className="flex justify-between items-center px-4 py-3 border-b border-gray-50 text-[13px] text-[var(--text-secondary)] font-medium h-12">
                    <div className="flex gap-4">
                        <span
                            ...
                            className={`flex items-center gap-1 cursor-pointer font-bold ${openOrderFilter === 'Futures' || openOrderFilter === 'All' ? 'text-[var(--text-primary)]' : 'text-[var(--text-tertiary)]'}`}
                        >
                            Futures <ChevronDown size={16} />
                        </span>
                        <span
                            onClick={() => setOpenOrderFilter(openOrderFilter === 'Spot' ? 'All' : 'Spot')}
                            className={`flex items-center gap-1 cursor-pointer font-bold ${openOrderFilter === 'Spot' || openOrderFilter === 'All' ? 'text-[var(--text-primary)]' : 'text-[var(--text-tertiary)]'}`}
                        >
    ...
    const renderOrderHistory = () => {
        return (
            <div className="flex flex-col">
                <div className="flex justify-between items-center px-4 py-3 border-b border-gray-50 text-[13px] text-[var(--text-secondary)] font-medium h-12">
                    <div className="flex gap-4">
                        <span className="flex items-center gap-1 cursor-pointer text-[var(--text-primary)] font-bold">Instrument <ChevronDown size={16} /></span>
                        <span className="flex items-center gap-1 cursor-pointer text-[var(--text-tertiary)] font-bold">Symbol <ChevronDown size={16} /></span>
                        <span className="flex items-center gap-1 cursor-pointer text-[var(--text-primary)] font-bold">Last 90 days <ChevronDown size={16} /></span>
                    </div>
                ...
                <div className="flex justify-between items-center px-4 py-3 border-b border-[var(--border-color)] text-[13px] text-[var(--text-secondary)] font-medium h-12 bg-[var(--bg-card)] sticky top-0 z-10">
                    <div className="flex gap-4">
                        <span
                            ...
                            className={`flex items-center gap-1 cursor-pointer font-bold ${posAssetFilter === 'Position' || posAssetFilter === 'All' ? 'text-[var(--text-primary)]' : 'text-[var(--text-tertiary)]'}`}
                        >
                            Position <ChevronDown size={16} />
                        </span>
                        <span
                            onClick={() => setPosAssetFilter(posAssetFilter === 'Assets' ? 'All' : 'Assets')}
                            className={`flex items-center gap-1 cursor-pointer font-bold ${posAssetFilter === 'Assets' || posAssetFilter === 'All' ? 'text-[var(--text-primary)]' : 'text-[var(--text-tertiary)]'}`}
                        >
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-[var(--bg-primary)] z-20 shrink-0 h-[52px]">
                ...
                <div className="font-bold text-[18px] text-[var(--text-primary)] absolute left-1/2 -translate-x-1/2">
                    My trades
                </div>
            ...
            <div className="flex items-center px-4 border-b border-[var(--border-color)] overflow-x-auto no-scrollbar shrink-0 bg-[var(--bg-primary)] z-20 h-12 box-border">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`py-3 px-2 whitespace-nowrap text-[15px] mr-4 relative h-full flex items-center ${activeTab === tab.id ? 'text-[var(--text-primary)] font-bold' : 'text-[var(--text-secondary)] font-medium'}`}
                    >
                        {tab.label}
